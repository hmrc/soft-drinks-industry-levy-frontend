...
trait RoutesWiring extends CommonWiring {
  ...
  lazy val orgTypeController: OrganisationTypeController = wire[OrganisationTypeController]
  ...
  lazy val packageCopackSmallVolumeController: VolumeForSmallProducersController = wire[VolumeForSmallProducersController]
