;(function (global) {
  ...
  function ShowHideContent2 () {
    var self = this

    // Radio and Checkbox selectors
    var selectors = {
      namespace: 'ShowHideContent',
      radio: '[showhide-target] > input[type="radio"]',
      checkbox: '[showhide-target] > input[type="checkbox"]'
    }
    ...
    function getToggledContent ($control) {
      ...
      if (!id) {
        id = $control.closest('[showhide-target]').data('target')
      }
  ...
  ShowHideContent2.prototype.init = function ($container) {
    this.showHideRadioToggledContent($container)
    this.showHideCheckboxToggledContent($container)
  }

  GOVUK.ShowHideContent = ShowHideContent2
  global.GOVUK = GOVUK
})(window)
